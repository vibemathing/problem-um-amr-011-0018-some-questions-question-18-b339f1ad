...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0018-some-questions-question-18-b339f1ad",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0018-484a0cd59f05",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0018"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For each $d\\geq3$, does the independence ratio of a uniformly random $d$-regular graph converge in probability as the number of vertices tends to infinity?",
      "version": 1
    },
    "title": "Some Questions — Question 18",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "55da93d52cc876d43a76f3bf12047ed43ce0301f7e3456d00b286100507a1178"
}
```
